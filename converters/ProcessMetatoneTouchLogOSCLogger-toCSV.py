...
## Preset mode
input_filename = '/Users/charles/Dropbox/Metatone/20130701/OSCLog20130701-17h20m46s.txt'
...
output_filename = input_filename.replace(".txt","") + '-messages.txt'
...
#processed_file.write('realtime, seconds, ipaddress, osc_address, device_id, x_pos, y_pos, velocity, switch_name, switch_state\n')
...
for line in raw_file:
    ...
    if(">" in message):
        ...
        #if (line_pieces[2] == "/metatone/ended"):        
        #if (line_pieces[2] == "/metatone/switch"):
