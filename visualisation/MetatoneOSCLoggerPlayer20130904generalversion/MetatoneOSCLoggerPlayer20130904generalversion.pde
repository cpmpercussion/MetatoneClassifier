...
//  startSecond = 3;
  ...
  // Open the file from the createWriter() example
  reader = createReader("/Users/charles/Dropbox/Metatone/20130504/MetatoneOSCLog-20130504-12h12-spacesep.txt");
  year = 2013;
  month = 5;
  day = 4;
  startHour = 12;
...
void draw() {
  ...
  while (currentLineTime < currentFrameTime) {
    ...
    if (currentLine != null) {
      ...
      } else if (currentLineParts[2].equals("/metatone/acceleration")) {
        // do nothing.
      } else {
