...
LEAD_PLAYER_DEVICE_ID = 'epec-ipad-1' # "gravitas" # "epec-ipad-4"
...
def set_matplotlib_style_solarized():
    """
    Sets rc params for matplotlib to have solarized style.
    Credit: https://github.com/expez/dotfiles/blob/master/solarized-matplotlib.py
    Credit: Stephan Porz
    """
    COLOR = {"yellow": "#B58900",
             "orange": "#CB4B16",
    ...
    mpl.rcParams.update({"ytick.color": DARK["0"],  # 'k'
                         ...
                         "axes.prop_cycle": mpl.cycler('color', [COLOR["blue"], COLOR["green"], COLOR["red"],
                                                   ...
                                                   COLOR["yellow"], DARK["0"]]),
                         # ['b', 'g', 'r', 'c', 'm', 'y', 'k']
                         "axes.edgecolor": DARK["0"],  # 'k'
                         "axes.facecolor": DARK["03"],  # 'w'
                         "axes.labelcolor": DARK["0"],  # 'k'
                         })
